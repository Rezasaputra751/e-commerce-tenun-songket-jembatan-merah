...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 30, 2022 at 06:41 AM
...
(1, 'nama-aplikasi', 'E-Commerce Tenun Songket Jembatan Merah', 'umum'),
(2, 'company-name', 'JMstore', 'umum'),
(3, 'company-address', 'Jalan Lintas Sumatera No. 11 A', 'umum'),
(4, 'company-phone', '0755-91444', 'umum'),
(5, 'company-email', 'JMstore@gmail.com', 'umum'),
...
(3, 'reza', 'pinus II', '089677557265', 'rezasaputra751@gmail.com', '318', 13);
...
(12, '1658928957', 2, '93', 'Alamat', '2022-07-27 20:35:57', 89900, 'jne', 'YES', 13000, 30, 'konfirmasi', 0),
(13, '1658993327', 2, '93', 'Alamat', '2022-07-28 14:28:47', 189000, 'jne', 'REG', 11000, 20, 'draft', 0),
(14, '1659018997', 2, '93', 'Alamat', '2022-07-28 21:36:37', 669000, 'jne', 'REG', 11000, 30, 'draft', 0),
(15, '1659040575', 2, '93', 'Alamat', '2022-07-29 03:36:15', 669000, 'jne', 'REG', 11000, 30, 'draft', 0),
(16, '1659430517', 3, '318', 'pinus II', '2022-08-02 15:55:17', 649000, 'jne', 'CTCYES', 10000, 30, 'draft', 20000),
(17, '1660212153', 2, '93', 'Alamat', '2022-08-11 17:02:33', 649000, 'jne', 'REG', 11000, 30, 'draft', 20000),
(18, '1660240796', 2, '93', 'Alamat', '2022-08-12 00:59:56', 499900, 'jne', 'YES', 13000, 30, 'draft', 0),
(19, '1660293397', 2, '93', 'Alamat', '2022-08-12 15:36:37', 29205000, 'tiki', 'REG', 8000, 30, 'draft', 20000),
(20, '1660300637', 2, '93', 'Alamat', '2022-08-12 17:37:17', 567000, 'tiki', 'REG', 8000, 20, 'draft', 0),
(21, '1660301032', 2, '93', 'Alamat', '2022-08-12 17:43:52', 649000, 'jne', 'REG', 11000, 30, 'draft', 20000),
(22, '1660301468', 2, '93', 'Alamat', '2022-08-12 17:51:08', 567000, 'jne', 'REG', 11000, 20, 'draft', 0),
(23, '1660371018', 2, '93', 'Alamat', '2022-08-13 13:10:18', 649000, 'jne', 'REG', 11000, 30, 'draft', 20000),
(24, '1660376592', 2, '93', 'Alamat', '2022-08-13 14:43:12', 200000, 'tiki', 'REG', 8000, 30, 'draft', 0),
(25, '1660376674', 2, '93', 'Alamat', '2022-08-13 14:44:34', 10000000, 'tiki', 'REG', 8000, 30, 'draft', 0),
(26, '1660825471', 2, '93', 'Alamat', '2022-08-18 19:24:31', 649000, 'jne', 'REG', 11000, 30, 'lunas', 20000);
...
(14, 14, 7, 1, 669000, 669000, ''),
(15, 15, 7, 1, 669000, 669000, ''),
(16, 16, 7, 1, 649000, 649000, ''),
(17, 17, 7, 1, 649000, 649000, ''),
(18, 18, 8, 1, 499900, 499900, ''),
(19, 19, 7, 45, 649000, 29205000, ''),
(20, 20, 9, 3, 189000, 567000, ''),
(21, 21, 7, 1, 649000, 649000, ''),
(22, 22, 9, 3, 189000, 567000, ''),
(23, 23, 7, 1, 649000, 649000, ''),
(24, 24, 10, 1, 200000, 200000, ''),
(25, 25, 10, 50, 200000, 10000000, ''),
(26, 26, 7, 1, 649000, 649000, '');

--
-- Triggers `penjualan_detail`
--
DELIMITER $$
CREATE TRIGGER `ins_jual` BEFORE INSERT ON `penjualan_detail` FOR EACH ROW BEGIN
	Update produk_stok SET stok=stok-NEW.QTY WHERE produk_id=NEW.produk_id;
END
$$
DELIMITER ;
...
(6, '1658928957', 1, 'Heru', '2022-07-27 20:41:18', '2022-07-27', 'bukti-1658928957.pdf', 12),
(7, '1660825471', 1, 'heru', '2022-08-18 19:25:50', '2022-08-18', 'bukti-1660825471.pdf', 26);
...
(7, 'A0001', 'Songket Merah Maroon', 3, 4, 6, '<p>deskripsi jaket lebih panjang</p>\r\n', 669000, 30, 0, 2),
(8, 'A0002', 'songket Biru', 3, 4, 6, '<p>deskripsi</p>\r\n', 499900, 30, 0, 4),
(9, 'A0003', 'Songket Merah Rendo Putih', 3, 4, 6, '<p>deskripsi</p>\r\n', 189000, 20, 0, 1),
(10, 'A0004', 'songket Hijau daun', 3, 4, 6, '<p>deskripsi</p>\r\n', 200000, 30, 0, 3);
...
(18, 6, 'produk_6-1.jpg'),
(22, 3, 'produk_3-1.jpg'),
(98, 7, 'produk_7-1.jpeg'),
(130, 9, 'produk_9-1.jpeg'),
(123, 8, 'produk_8-2.jpeg'),
(122, 8, 'produk_8-1.jpeg'),
(126, 10, 'produk_10-1.jpeg');
...
(3, 'Tenun Songket Jembatan Merah Silungkang', 'Lintas Sumatera\r\nNo.13', '55555', '394', 'cabang');
...
(1, 'Administrator', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin', 'ava-c4ca4238a0b923820dcc509a6f75849b.png', 'aktif', '2022-08-12 17:38:24', NULL),
(4, 'Operator', 'op', '11d8c28a64490a987612f2332502467f', 'op', 'ava-a87ff679a2f3e71d9181a67b7542122c.png', 'aktif', '2022-08-18 19:25:59', NULL),
(5, 'pimpinan', 'bos', '90973652b88fe07d05a4304f0a945de8', 'bos', 'ava-e4da3b7fbbce2345d7772b0674a318d5.png', 'aktif', '2022-08-18 19:26:44', NULL),
(9, 'Heru', 'heru', 'a648ab9a3e32c5f3f6e9ddbd41c0530f', 'member', '', 'aktif', '2022-08-18 19:23:36', NULL),
(8, 'Esti Oneng', 'jkt', 'a936a0058e0963ff14134e1d47dc8107', 'member', '', 'aktif', '2016-05-21 19:08:30', NULL),
(12, 'Supplier Akun 1', 's1', '8ddf878039b70767c4a5bcf4f0c4f65e', 'supplier', '', 'aktif', '2022-08-02 04:58:50', NULL),
(13, 'reza', 'Nastyyyza', '886d683a316a763e520332311971c12d', 'member', '', 'aktif', '2022-08-02 15:55:00', NULL);
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_produk`  AS  select `produk`.`produk_id` AS `produk_id`,`produk`.`kode_produk` AS `kode_produk`,`produk`.`nama_produk` AS `nama_produk`,`produk`.`supplier_id` AS `supplier_id`,`produk`.`merek_id` AS `merek_id`,`produk`.`kategori_id` AS `kategori_id`,`produk`.`deskripsi` AS `deskripsi`,`produk`.`harga` AS `harga`,`produk`.`berat` AS `berat`,`produk`.`jumlah_lihat` AS `jumlah_lihat`,`produk`.`jumlah_beli` AS `jumlah_beli`,`produk_stok`.`toko_id` AS `toko_id`,`produk_stok`.`stok` AS `stok`,`produk_stok`.`stok_mutasi` AS `stok_mutasi`,`produk_stok`.`stok_jual` AS `stok_jual` from (`produk` join `produk_stok`) where (`produk`.`produk_id` = `produk_stok`.`produk_id`) ;
...
--
ALTER TABLE `penjualan_detail`
  MODIFY `penjualan_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `produk_photo`
  MODIFY `photo_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=134;
...
--
ALTER TABLE `promo_data`
  MODIFY `promo_data_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
